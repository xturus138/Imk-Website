        ...
        <body style="background-color:paleturquoise;">
            ...
            <div class="w3-container w3-margin w3-animate-zoom">
                <div style="position: relative;">
                    <label for="inlap" style="position: absolute; top: 5px; left: 10px;">Tulis Pengumuman Disini</label>
                ...
                <div style="position: relative;">
                    <label for="outlap" style="position: absolute; top: 5px; left: 10px;">List Pengumuman</label>
