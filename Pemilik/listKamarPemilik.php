...
<div class="w3-row w3-animate-opacity">
    <div class="w3-half w3-container">
        ...
        <div class="w3-row">
            <div class="w3-col marginCustom">
                <button type=submit name="listkamar" class="w3-button occupied w3-ripple w3-hover-green" value="kamar2" onclick="link()"><h1>Kamar 2</h1><span class="status-text">Diisi</span></button>
            </div>
        </div>
        <div class="w3-row">
            <div class="w3-col marginCustom">
